package Lesson3.HomeWorke.Task1MusicApp;
...
//java.lang.IllegalArgumentException: There is no playlist with title: Pop
//	at Lesson3.HomeWorke.Task1MusicApp.User.addSongToPlaylist(User.java:42)
//	at Lesson3.HomeWorke.Task1MusicApp.MusicRunner.main(MusicRunner.java:24)
//Rock
//30000
//[Song{title='Polly', author='Nirvana'}, Song{title='Come as you are', author='Nirvana'}]
//[Song{title='Symphony nr. 40 g-moll', author='Mozart'}]
//
